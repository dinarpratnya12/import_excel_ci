                    ...
                    <ul class=" navbar-nav my-lg-0" style="padding-top: 10px; padding-bottom: 10px">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated zoomIn" aria-labelledby="2"  id="notification">
                                <ul>
                                    <li>
                                        <div class="drop-title">You have 2 new updates</div>
                                    </li>
                                    <li>
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div></a>
