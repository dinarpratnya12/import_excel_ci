...
<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Master Output</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                        <li class="breadcrumb-item active">Master Output</li>
                    </ol>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <a href="<?php echo base_url("index.php/MasterOut/form");?>"><button type="button" class="btn btn-primary float-right"><span class="fa fa-plus"></span>&nbsp;Upload Master Output</button></a>
                ...
                <div class="table-responsive">
                    <table class="table table-hover" id="example">
                        ...
                        <tbody>
                        <?php
                            if( ! empty($masterout)){ // Jika data pada database tidak sama dengan empty (alias ada datanya)
                                        foreach($masterout as $data){ // Lakukan looping pada variabel siswa dari controller
                                            echo "<tr>";
                                            echo "<td>".$data->no."</td>";
                                            echo "<td>".$data->tglout."</td>";
                                            echo "<td>".$data->codebrg."</td>";
                                            echo "<td>".$data->qtyout."</td>";
                                            echo "<td>".$data->line."</td>";
                                            echo "<td>".$data->controlno."</td>";
                                ...
                                echo "<tr><td colspan='8'><center> Data tidak ada</center></td></tr>";
                            } ?>
                        </tbody>
                    </table>
                </div>
